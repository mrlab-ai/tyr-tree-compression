...
template float_t evaluate(float_t element, const StateContext<LiftedTask>& context);
template float_t evaluate(float_t element, const StateContext<GroundTask>& context);
...
template float_t evaluate(formalism::planning::GroundMultiOperatorView<formalism::OpAdd> element, const StateContext<GroundTask>& context);
template float_t evaluate(formalism::planning::GroundMultiOperatorView<formalism::OpMul> element, const StateContext<GroundTask>& context);

template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::StaticTag> element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::StaticTag> element, const StateContext<GroundTask>& context);

template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::FluentTag> element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::FluentTag> element, const StateContext<GroundTask>& context);

template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::AuxiliaryTag> element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundFunctionTermView<formalism::AuxiliaryTag> element, const StateContext<GroundTask>& context);

template float_t evaluate(formalism::planning::GroundFunctionExpressionView element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundFunctionExpressionView element, const StateContext<GroundTask>& context);
...
template float_t evaluate(formalism::planning::GroundNumericEffectView<formalism::planning::OpAssign, formalism::FluentTag> element,
                          const StateContext<LiftedTask>& context);
...
template float_t evaluate(formalism::planning::GroundNumericEffectView<formalism::planning::OpIncrease, formalism::AuxiliaryTag> element,
                          const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectView<formalism::planning::OpAssign, formalism::FluentTag> element,
                          const StateContext<GroundTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectView<formalism::planning::OpIncrease, formalism::FluentTag> element,
                          const StateContext<GroundTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectView<formalism::planning::OpDecrease, formalism::FluentTag> element,
                          const StateContext<GroundTask>& context);
...
template float_t evaluate(formalism::planning::GroundNumericEffectOperatorView<formalism::FluentTag> element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectOperatorView<formalism::AuxiliaryTag> element, const StateContext<LiftedTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectOperatorView<formalism::FluentTag> element, const StateContext<GroundTask>& context);
template float_t evaluate(formalism::planning::GroundNumericEffectOperatorView<formalism::AuxiliaryTag> element, const StateContext<GroundTask>& context);
...
template bool is_applicable(formalism::planning::GroundLiteralView<formalism::StaticTag> element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundLiteralView<formalism::StaticTag> element, const StateContext<GroundTask>& context);

template bool is_applicable(formalism::planning::GroundLiteralView<formalism::DerivedTag> element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundLiteralView<formalism::DerivedTag> element, const StateContext<GroundTask>& context);

template bool is_applicable(formalism::planning::GroundLiteralListView<formalism::StaticTag> elements, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundLiteralListView<formalism::DerivedTag> elements, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundLiteralListView<formalism::StaticTag> elements, const StateContext<GroundTask>& context);
template bool is_applicable(formalism::planning::GroundLiteralListView<formalism::DerivedTag> elements, const StateContext<GroundTask>& context);

template bool is_applicable(formalism::planning::FDRFactView<formalism::FluentTag> element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::FDRFactView<formalism::FluentTag> element, const StateContext<GroundTask>& context);

template bool is_applicable(formalism::planning::FDRFactListView<formalism::FluentTag> elements, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::FDRFactListView<formalism::FluentTag> elements, const StateContext<GroundTask>& context);

template bool is_applicable(formalism::planning::GroundBooleanOperatorListView elements, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundBooleanOperatorListView elements, const StateContext<GroundTask>& context);
...
template bool is_applicable(formalism::planning::GroundNumericEffectOperatorView<formalism::AuxiliaryTag> element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundNumericEffectOperatorView<formalism::AuxiliaryTag> element, const StateContext<GroundTask>& context);

// GroundConjunctiveCondition

template bool is_applicable(formalism::planning::GroundConjunctiveConditionView element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundConjunctiveConditionView element, const StateContext<GroundTask>& context);
...
template bool is_applicable(formalism::planning::GroundAxiomView element, const StateContext<LiftedTask>& context);
template bool is_applicable(formalism::planning::GroundAxiomView element, const StateContext<GroundTask>& context);
...
template bool is_dynamically_applicable(formalism::planning::GroundConjunctiveConditionView element, const StateContext<LiftedTask>& context);
template bool is_dynamically_applicable(formalism::planning::GroundConjunctiveConditionView element, const StateContext<GroundTask>& context);
