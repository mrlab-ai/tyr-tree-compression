...
#ifndef TYR_PLANNING_GROUND_TASK_MATCH_TREE_NODES_NEGATIVE_FACT_VIEW_HPP_
#define TYR_PLANNING_GROUND_TASK_MATCH_TREE_NODES_NEGATIVE_FACT_VIEW_HPP_
...
class View<Index<planning::match_tree::NegativeFactSelectorNode<Tag>>, C>
{
private:
    const C* m_context;
    Index<planning::match_tree::NegativeFactSelectorNode<Tag>> m_handle;

public:
    View(Index<planning::match_tree::NegativeFactSelectorNode<Tag>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
