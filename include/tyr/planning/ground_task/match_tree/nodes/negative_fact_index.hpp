...
struct Index<planning::match_tree::NegativeFactSelectorNode<Tag>> : IndexMixin<Index<planning::match_tree::NegativeFactSelectorNode<Tag>>>
{
    // Inherit constructors
    using Base = IndexMixin<Index<planning::match_tree::NegativeFactSelectorNode<Tag>>>;
    using Base::Base;
};
