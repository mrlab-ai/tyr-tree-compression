...
#ifndef TYR_PLANNING_GROUND_TASK_STATE_STORAGE_HASH_SET_FACT_HPP_
#define TYR_PLANNING_GROUND_TASK_STATE_STORAGE_HASH_SET_FACT_HPP_
...
template<>
struct FactPackedStorage<GroundTag, HashSet>
{
    uint_t index;
