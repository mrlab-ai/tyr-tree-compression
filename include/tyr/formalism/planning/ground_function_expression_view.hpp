...
template<typename C>
auto make_view(const Data<formalism::planning::GroundFunctionExpression>& element, const C& context) noexcept
{
    return View<Data<formalism::planning::GroundFunctionExpression>, C>(element,
                                                                        std::visit(
