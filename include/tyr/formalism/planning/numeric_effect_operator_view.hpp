...
auto make_view(const Data<formalism::planning::NumericEffectOperator<T>>& element, const C& context) noexcept
{
    return View<Data<formalism::planning::NumericEffectOperator<T>>, C>(
        element,
