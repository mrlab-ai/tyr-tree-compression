...
class View<Data<formalism::planning::ArithmeticOperator<T>>, C>
{
private:
    const C* m_context;
    Data<formalism::planning::ArithmeticOperator<T>> m_handle;

public:
    View(Data<formalism::planning::ArithmeticOperator<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
