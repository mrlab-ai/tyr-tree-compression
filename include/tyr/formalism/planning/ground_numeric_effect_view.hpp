...
class View<Index<formalism::planning::GroundNumericEffect<Op, T>>, C>
{
...
private:
    const C* m_context;
    Index<formalism::planning::GroundNumericEffect<Op, T>> m_handle;

public:
    View(Index<formalism::planning::GroundNumericEffect<Op, T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
