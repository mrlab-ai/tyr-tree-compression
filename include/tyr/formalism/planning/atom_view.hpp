...
class View<Index<formalism::planning::Atom<T>>, C>
{
private:
    const C* m_context;
    Index<formalism::planning::Atom<T>> m_handle;

public:
    View(Index<formalism::planning::Atom<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
