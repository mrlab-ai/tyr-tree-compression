...
class View<Index<formalism::planning::Literal<T>>, C>
{
private:
    const C* m_context;
    Index<formalism::planning::Literal<T>> m_handle;

public:
    View(Index<formalism::planning::Literal<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
