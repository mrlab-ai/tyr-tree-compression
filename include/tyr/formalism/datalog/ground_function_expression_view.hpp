...
class View<Data<formalism::datalog::GroundFunctionExpression>, C>
{
private:
    const C* m_context;
    Data<formalism::datalog::GroundFunctionExpression> m_handle;

public:
    View(Data<formalism::datalog::GroundFunctionExpression> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
...
template<typename C>
auto make_view(const Data<formalism::datalog::GroundFunctionExpression>& element, const C& context) noexcept
{
    return View<Data<formalism::datalog::GroundFunctionExpression>, C>(element,
                                                                       std::visit(
