...
class View<Index<formalism::datalog::GroundFunctionTermValue<T>>, C>
{
private:
    const C* m_context;
    Index<formalism::datalog::GroundFunctionTermValue<T>> m_handle;

public:
    View(Index<formalism::datalog::GroundFunctionTermValue<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
