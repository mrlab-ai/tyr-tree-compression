...
class View<Index<formalism::datalog::Atom<T>>, C>
{
private:
    const C* m_context;
    Index<formalism::datalog::Atom<T>> m_handle;

public:
    View(Index<formalism::datalog::Atom<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
