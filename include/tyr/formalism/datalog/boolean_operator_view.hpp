...
class View<Data<formalism::datalog::BooleanOperator<T>>, C>
{
private:
    const C* m_context;
    Data<formalism::datalog::BooleanOperator<T>> m_handle;

public:
    View(Data<formalism::datalog::BooleanOperator<T>> handle, const C& context) noexcept : m_context(&context), m_handle(handle) {}
