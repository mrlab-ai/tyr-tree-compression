...
exp.add_fetcher("../../1-2026-1-8-gbfs_lazy-profiling-classical-1-eval", filter=rename_algorithm)
exp.add_fetcher("../../2-2026-1-8-gbfs_lazy-profiling-classical-1-eval")
