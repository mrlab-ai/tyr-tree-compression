...
exp_htg.add_fetcher("results_raw/6-2026-1-8-gbfs_lazy-1-eval", filter=normalize_htg)
...
exp_autoscale.add_fetcher("results_raw/6-2026-1-8-gbfs_lazy-1-eval", filter=normalize_autoscale)
...
exp.add_fetcher("results_raw/6-2026-1-8-gbfs_lazy-1-eval", filter=normalize)
